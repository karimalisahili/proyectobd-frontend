            ...
            <AppBar position="static" sx={{minWidth:'100%',
               ...
               boxShadow: shouldChangeBoxShadow ? '0px 3px 5px -3px rgba(0,0,0,0.75)' : '201px 3px 5px -3px rgba(0,0,0,0.75)'
                ...
                left:0}}>
                            ...
                            <Button onClick={() => { handleNbLateral({ title1: 'Proveedores', title2:'REQUISICIONES DE COMPRAS',title3: 'ORDENES DE COMPRA', title4: 'Facturas', title5: '', title6:'' ,padre:'proveedores', listType:'ProveedoresLista'}, 'proveedores'); }} sx={{ my: 2, ml: 4, color: 'white', display: 'block', borderBottom: opcionActiva === 'proveedores' ? '6px solid green' : 'none' }}>
