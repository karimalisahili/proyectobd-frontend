                ...
                <Container>
                    <Toolbar>
                        <Box sx={{ flexGrow: 2, display: { xs: 'none', md: 'flex' } }}>
                            ...
                            <Button onClick={() => { handleNbLateral({ title1: 'Compras', title2: 'Pagos', title3: 'Facturas', title4: '', padre:'tienda', listType:'listaProductos'}); }} sx={{ my: 2, mx: 4, color: 'white', display: 'block' }}>
                            ...
                            <Button onClick={() => { handleNbLateral({ title1: 'Productos', title2: 'Ajustes', title3: 'Vehiculo', title4: '', padre:'inventario', listType:''}); }} sx={{ my: 2, mx: 4, color: 'white', display: 'block' }}>
